"""
Django settings for slackk_40719 project.
...
ROOT_URLCONF = 'slackk_40719.urls'
...
WSGI_APPLICATION = 'slackk_40719.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "slackk_40719 API",
    "DESCRIPTION": "API documentation for slackk_40719 App",
    "VERSION": "v1",
}
